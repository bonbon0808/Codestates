...
public class part2 {
  ...
  */
  public static final String PART2_3 = "INSERT INTO user (name, email) VALUES ('kim','ioi@naver.com')";
  ...
  */
  public static final String PART2_5 = "SELECT * FROM user WHERE name <> 'luckykim'";
  ...
  */
  public static final String PART2_10 = "INSERT INTO content (userID,title,body) VALUES (1, 'NINETYTWO', 'TWENTYNINE')";
}
